...
if($_SESSION['ContNotify']>=1){
    $QueryCleanTopNotifications = "UPDATE notifications SET visualizado='1' WHERE id_conta='".$_SESSION['IsLogged']."' AND visualizado='0' ORDER BY data_notification DESC LIMIT 3";
