...
$QueryInsertNotification = "INSERT INTO notifications(id_conta,descricao,tipo_notification,data_notification,visualizado) VALUES ('".$_SESSION['IsLogged']."','Deleção em ferramentas','4','".date('Y-m-d H:i:s')."','0')";
...
$QueryDeleteExists = "DELETE FROM usertools WHERE tipotool=4 AND id_conta='".$_SESSION['IsLogged']."'";
